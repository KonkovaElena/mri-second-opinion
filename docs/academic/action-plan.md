...
Дата: 2026-03-28 | Метод: синтез аудитов, active docs, кода и внешнего исследования
...
4. Wave 2A execution-truth slice начат: artifact manifest вынесен в first-class case state, но hosted evidence и worker boundary ещё не закрыты
...
1. закрыть authority docs и evidence baseline
2. закрыть execution truth
3. закрыть real compute path
4. закрыть archive and viewer truth
5. закрыть export and regulatory pack
6. только потом перейти к clinical evidence
...
| Wave 2A | Execution truth and queue substrate | in progress | блокирует real worker |
...
2. Wave 2A execution truth
3. Wave 2B compute plane
4. Wave 3A archive/viewer
5. Wave 3B artifact/report closure
6. Wave 4 exports + regulatory pack
7. Wave 5 clinical evidence
...
2. после этого открыть Wave 2A implementation plan по конкретным файлам runtime surface
