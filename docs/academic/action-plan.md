...
3. ✅ evidence ledger связывает runtime version, docs version и validation results — release-validation-packet.md links the current local validation snapshot with 136 tests, tsc clean, export validation, all doc versions, and known gaps
