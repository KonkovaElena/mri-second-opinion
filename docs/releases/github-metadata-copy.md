...
This file contains the exact recommended copy for GitHub-facing metadata and short project descriptions.

Use it when configuring the repository About panel, preparing the social preview, or writing short external summaries.
...
MRI-only clinician-reviewed workflow baseline with a standalone TypeScript API.
...
## About panel guidance

### Description

Use the primary one-line description.
...
Do not invent a vanity URL or docs site before the hosted repository is stable.

## Suggested topics

Use only topics that reflect actual scope and current implementation direction.
