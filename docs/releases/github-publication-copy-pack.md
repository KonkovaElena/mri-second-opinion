...
# GitHub Publication Copy Pack

## Purpose

This file is the final copy pack for live GitHub publication and external communication.

It consolidates the shortest approved language for:

1. About metadata
2. pinned discussion or repository overview text
3. release blurb
4. social preview text
5. short-form external summaries

Use this pack when a platform or maintainer needs copy quickly without re-deriving wording from multiple docs.

## Governing Rule

Every line below must remain inside one of these categories:

1. implemented repository truth
2. clearly labeled target direction
3. research-informed context that is not presented as runtime proof

No short-form copy may imply:
...
Leave blank until a real public documentation site, GitHub Pages site, or product URL exists.
...
2. 50 characters or fewer per topic
3. no more than 20 topics total
...
4. `docs/academic/evidence-and-claims-policy.md`
...
2. under 1 MB
3. at least 640x320
4. 1280x640 recommended for best display
5. solid background preferred unless transparency is tested across platforms
